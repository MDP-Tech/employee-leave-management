$("#timepicker").timepicker({
    ...
    $("#timepicker2").timepicker({
        ...
        ,$("#timepicker3").timepicker({showSeconds:!0,minuteStep:15,icons:{up:"ri-arrow-up-s-line",down:"ri-arrow-down-s-line"},appendWidgetTo:"#timepicker-input-group3"}),
	$("#basic-datepicker").flatpickr(),
	$("#datetime-datepicker").flatpickr({enableTime:!0,dateFormat:"Y-m-d H:i"}),
	$("#humanfd-datepicker").flatpickr({altInput:!0,altFormat:"F j, Y",dateFormat:"Y-m-d"}),
	$("#minmax-datepicker").flatpickr({minDate:"2020-01",maxDate:"2020-03"}),
	$("#disable-datepicker").flatpickr({onReady:function(){this.jumpToDate("2025-01")},disable:["2025-01-10","2025-01-21","2025-01-30",new Date(2025,4,9)],dateFormat:"Y-m-d"}),
	$("#multiple-datepicker").flatpickr({mode:"multiple",dateFormat:"Y-m-d"}),$("#conjunction-datepicker").flatpickr({mode:"multiple",dateFormat:"Y-m-d",conjunction:" :: "}),
	$("#range-datepicker").flatpickr({mode:"range"}),
	$("#inline-datepicker").flatpickr({inline:!0}),
	$("#basic-timepicker").flatpickr({enableTime:!0,noCalendar:!0,dateFormat:"H:i"}),
        $("#24hours-timepicker").flatpickr({
            ...
            onChange: function(selectedDates, dateStr, instance) {
                ...
                if ((selectedHour > 11 && selectedHour <13 && selectedMinute >= 45) || (selectedHour === 13 && selectedMinute < 45)) {
                    // updatedHour = (selectedHour + 1) % 24; // Increment by 2 hours to skip the disabled range
                    instance.input.value='13:45';
                    instance.hourElement.value=13;
                    instance.minuteElement.value=45;

                    $('#validationCustom02').val('14:45');
                } else {
